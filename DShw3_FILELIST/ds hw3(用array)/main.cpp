...
{   int j=1;
    ...
    compareList.push_back("Commander_Spock");
     compareList.push_back("Commander_Spoc");compareList.push_back("Commander_Spo");
    ...
    handler.addFileName("Captain_Kirk");
    handler.addFileName("Enterprise");
    handler.addFileName("Commander_Spock");
     handler.addFileName("Commander_Spoc"); handler.addFileName("Commander_Spo");
    ...
    if (fileList.size()!=compareList.size()) {
        //cout<<fileList.size()<<" "<<compareList.size();
        cout<<fileList[0];
